            ...
            <PreviewModal open={openNavigate} setOpen={setOpenNavigate}>
                <div className='bg-gray-200 text-lg rounded-md p-2'>
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <div className=''>
                            <p className='text-left'>To reserve a seat it is neccessary to logged in to your account. Please <Link to={"/login"} className='underline'>login</Link> if you have an account! If not <Link to={"/signup/student"} className='underline'>Signup</Link> to have an account!</p>
                        </div>

                        <div className='flex items-center justify-around text-center w-full space-x-4 mt-4'>
                            <Link to="/signup/student" className={`w-40 p-1.5 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}>
                                <span>SignUp</span>
                            </Link>
